...
pub fn query(
    ...
    sum_accumulator.set_group_key(vec!["l_orderkey".into(),"o_orderdate".into(),"o_shippriority".into()]);
    ...
    lo_hash_join_node.subscribe_to_node(&lineitem_where_node, 0); // Left Node
