...
fn main() {
    ...
    match args[0].as_str() {
        ...
        _ => panic!("Invalid Argument to the cargo run command.
...
pub fn get_query_service(
    ...
    let query_service = match query_no {
        ...
        // "q3" => q3::query(table_input, &mut output_reader),
        // "q6" => q6::query(table_input, &mut output_reader),
        // "q10" => q10::query(table_input, &mut output_reader),
        "q14" => q14::query(table_input, output_reader),
        // "q19" => q19::query(table_input, &mut output_reader),
