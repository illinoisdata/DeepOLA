...
fn main() {
        ...
        table_input.insert(
            ...
            TableInput {
                ...
                input_files: vec![format!(
                    "src/resources/tpc-h/scale=1/partition=1/{}.tbl",
                    tpch_table
                )],
                scale: 1,
            },
    ...
    if query.len() != 0 {
        match query[0].as_str() {
            ...
            "q5" => {
                query_service = q5::query(table_input, &mut output_reader);
            }
            "q6" => {
                query_service = q6::query(table_input, &mut output_reader);
            }
            "q10" => {
                query_service = q10::query(table_input, &mut output_reader);
            }
            "q12" => {
            ...
            "q19" => {
                query_service = q19::query(table_input, &mut output_reader);
            }
