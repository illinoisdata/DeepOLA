...
DATA_BASE_DIR = os.environ.get("DATA_BASE_DIR", "/dataset/tpch")
...
DATASET_BASE_DIR = os.path.join(DATA_BASE_DIR, f"scale={SCALE_FACTOR}/partition={PARTITION}/parquet/")
ANSWERS_BASE_DIR = os.path.join(DATA_BASE_DIR, f"scale={SCALE_FACTOR}/original/")
