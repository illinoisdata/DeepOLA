...
/// reading csv files
impl CSVReader {
    pub fn new_with_params(batch_size: usize, delimiter: char, has_headers: bool, filtered_cols: Vec<String>) -> Box<dyn SetProcessorV1<Series>> {
