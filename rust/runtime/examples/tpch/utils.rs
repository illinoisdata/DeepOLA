...
pub fn tpch_schema(table: &str) -> Result<Schema, Box<dyn Error>> {
    let columns = match table {
        ...
        "customer" => vec![
            Column::from_field("c_custkey".to_string(), DataType::Integer),
        ...
        "supplier" => vec![
            Column::from_field("s_suppkey".to_string(), DataType::Integer),
        ...
        "nation" => vec![
            Column::from_field("n_nationkey".to_string(), DataType::Integer),
        ...
        "region" => vec![
            Column::from_field("r_regionkey".to_string(), DataType::Integer),
            Column::from_field("r_name".to_string(), DataType::Text),
            Column::from_field("r_comment".to_string(), DataType::Text),
        ],
        "part" => vec![
            Column::from_field("p_partkey".to_string(), DataType::Integer),
        ...
        "partsupp" => vec![
            Column::from_field("ps_partkey".to_string(), DataType::Integer),
            Column::from_field("ps_suppkey".to_string(), DataType::Integer),
